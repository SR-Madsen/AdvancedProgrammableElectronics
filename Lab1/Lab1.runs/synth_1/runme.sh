...
HD_PWD='/home/sebastian/Desktop/Git/AdvancedProgrammableElectronics/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_inverter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_inverter.tcl
