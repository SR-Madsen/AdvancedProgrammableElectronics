...
HD_PWD='/home/sebastian/Desktop/Git/AdvancedProgrammableElectronics/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_inverter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_inverter.tcl -notrace
