...
HD_PWD='/home/sebastian/Desktop/Git/AdvancedProgrammableElectronics/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log qltest_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source qltest_top.tcl -notrace
