...
HD_PWD='/home/sebastian/Desktop/Git/AdvancedProgrammableElectronics/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qltest_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qltest_top.tcl
